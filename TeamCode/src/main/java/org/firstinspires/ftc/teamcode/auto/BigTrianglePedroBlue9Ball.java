...
@Autonomous
public class BigTrianglePedroBlue9Ball extends OpMode {
    ...
    public static Pose shootingPositionToSemiSecondRowEndPose = new Pose(42.576, 59.780);
    public static Pose semiSecondRowToSecondRowEndPose = new Pose(3, 60.8);
    public static Pose secondRowToShootingPositionEndPose = new Pose (57.819, 74.009);
    ...
    public void buildPaths(Follower follower) {
        ...
        shootingPositionToSemiSecondRowPosition = follower.pathBuilder().addPath(
                        new BezierCurve(
                                thirdRowToShootingPositionEndPose,
                                new Pose(66.951, 59.635),
                                shootingPositionToSemiSecondRowEndPose
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(181),startHeading)
        ...
        semiSecondRowToSecondRowPosition = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(startHeading,Math.toRadians(165))
        ...
        secondRowToShootingPosition = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(165),Math.toRadians(181))
