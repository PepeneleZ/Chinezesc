...
//       | |
  ...
  @Config
  public class SortingV2 implements  Updateable{
  //---------MOTORS--------------------
  ...
  //----------STATES-----------------
      ...
      public SortingV2(HardwareMap hwmap, Telemetry telemetry, Intake intake, VoltageSensor voltageSensor){
...
//                  rotate_elice(0.5);
  ...
  //SHOOOOOOOOOOOOOOOOOOOOOOOOOOOOOTIIIIIIIIIIIIIIIIIIIIIINNNNNNNNNNNNNNNNNNNGGGGGGGGG
          if (current_moving_state == MOVING_STATES.SHOOTING){
              ...
              if (magazine[5]==shooting_order[shooting_index++]) rotate_elice(0);
              else if (magazine[1]==shooting_order[shooting_index++]) rotate_elice(-1);
              else if (magazine[3]==shooting_order[shooting_index++])rotate_elice(1);
